<?php 
	namespace KirillAntonov\TicTacToe\Controller;

    use KirillAntonov\ticTacToe\Model\Board as Board;
    use Exception as Exception;
    use LogicException as LogicException;

    use function KirillAntonov\TicTacToe\View\showGameBoard;
    use function KirillAntonov\TicTacToe\View\showMessage;
    use function KirillAntonov\TicTacToe\View\getValue;

    use const KirillAntonov\TicTacToe\Model\PLAYER_X_MARKUP;
    use const KirillAntonov\TicTacToe\Model\PLAYER_O_MARKUP;
...
function getCoords($board)
{
    ...
    $coords = getValue("Enter the coordinates for the player '$markup' through '-'. First Y coordinate, second X coordinate");
